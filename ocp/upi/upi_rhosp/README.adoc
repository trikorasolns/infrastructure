...
[source,bash]
----
ansible-playbook ocp/4.16/ansible/02-ocp-services-oi-binaries.yaml \
...
[source,bash]
----
ansible-playbook ocp/4.16/upi_rhosp/ansible/18-ocp-services-oi-playbook.yaml \
  -e @ocp/4.16/ansible/defaults/main.yaml \
...
[source,bash]
----
ansible-playbook ocp/4.16/upi_rhosp/ansible/20-rhosp-prepare.yaml \
  -e @ocp/4.16/ansible/defaults/main.yaml \
...
[source,bash]
----
ansible-playbook ocp/4.16/upi_rhosp/ansible/20.14-rhosp-load-balancer.yaml \
  -e @ocp/4.16/ansible/defaults/main.yaml \
  -e @ocp/4.16/upi_rhosp/ansible/defaults/main.yaml \
  -e @_local_config/network.yaml \
  -e @_local_config/${OCP_CLUSTER_NAME}/${OCP_CLUSTER_NAME}.yaml \
...
[source,bash]
----
ansible-playbook ocp/4.16/upi_rhosp/ansible/29-rhosp-print-dns-info.yaml   -e @ocp/4.16/ansible/defaults/main.yaml   -e @ocp/4.16/upi_rhosp/ansible/defaults/main.yaml   -e @_local_config/network.yaml   -e @_local_config/${OCP_CLUSTER_NAME}/${OCP_CLUSTER_NAME}.yaml   -e ocp_cluster_name=${OCP_CLUSTER_NAME}
----
...
[source,bash]
----
ansible-playbook ocp/4.16/upi_rhosp/ansible/20.19-rhosp-compute-node-instance.yaml \
  -e @_local_config/network.yaml \
  -e @ocp/4.16/ansible/defaults/main.yaml \
  -e @ocp/4.16/upi_rhosp/ansible/defaults/main.yaml \
  -e @_local_config/${OCP_CLUSTER_NAME}/${OCP_CLUSTER_NAME}.yaml 
...
[source,bash]
----
ansible-playbook ocp/4.16/upi_rhosp/ansible/50-ocp-storage-cinder.yaml \
  -e @_local_config/network.yaml \
  -e @ocp/4.16/ansible/defaults/main.yaml \
  -e @ocp/4.16/upi_rhosp/ansible/defaults/main.yaml \
  -e @_local_config/${OCP_CLUSTER_NAME}/${OCP_CLUSTER_NAME}.yaml \
...
[source,bash]
----
oc apply -f ocp/4.16/upi_rhosp/ansible/files/kubernetes-cloud-provider-openstack-cinder-test.yaml
----
...
[source,bash]
----
oc delete -f ocp/4.16/upi_rhosp/ansible/files/kubernetes-cloud-provider-openstack-cinder-test.yaml
----
...
[source,bash]
----
ansible-playbook ocp/4.16/upi_rhosp/ansible/95-ocp-storage-manila-cleanup.yaml \
  -e @_local_config/network.yaml \
  -e @ocp/4.16/ansible/defaults/main.yaml \
  -e @ocp/4.16/upi_rhosp/ansible/defaults/main.yaml \
  -e @_local_config/${OCP_CLUSTER_NAME}/${OCP_CLUSTER_NAME}.yaml
...
[source,bash]
----
oc apply -f ocp/4.16/upi_rhosp/ansible/files/kubernetes-cloud-provider-openstack-manila-test.yaml
----
...
[source,bash]
----
oc delete -f ocp/4.16/upi_rhosp/ansible/files/kubernetes-cloud-provider-openstack-manila-test.yaml
----
...
* https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/operators/cluster-operators-ref#cluster-storage-operator_cluster-operators-ref
* https://github.com/openshift/cluster-storage-operator/tree/release-4.16
