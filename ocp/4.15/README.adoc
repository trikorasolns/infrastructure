...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/01-proxmox-vms.yaml \
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/20-proxmox-execute-coreos-install.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml
----
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/28-proxmox-vm-start-deployment.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml
----
