...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/18-ocp-services-oi-playbook.yaml -K \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml \
  -e @_local_config/network.yaml \
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/50-ocp-services-get-ocp-auth-playbook.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml
----
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/99-ocp-services-ocp-clean-playbook.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml \
