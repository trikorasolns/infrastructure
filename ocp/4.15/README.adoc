...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/02-ocp-services-oi-binaries.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml
----

Generate the _OpenShift Install_ installation folder and generate the 
 Kubernetes manifests and Ignition configuration files for the cluster. This is done using the `openshift-install` CLI.

[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/03-ocp-services-oi-playbook.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml \
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/10-ocp-services-config-playbook.yaml -K \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml
----
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/15-ocp-services-haproxy-playbook.yaml -K \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml \
  -e @_local_config/network.yaml
----
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/20-proxmox-prepare-coreos-install.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml \
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/25-ocp-services-show-rhcos-info.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml
----
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/28-proxmox-vm-start.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml
----
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/30-vm-fix-cnio.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml
----

Wait for the 3 Control Plane nodes to be created. From the openshift root folder on 
 the _ocp_services_ host execute the following command.

[source,bash]
----
./oc --kubeconfig ~/openshift/install_dir/auth/kubeconfig get nodes
----
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/31-ocp-services-remove-cp-taints.yaml \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml
----
...
[source,bash]
----
ansible-playbook ocp/4.15/upi/ansible/35-ocp-services-remove-bootstrap-haproxy-playbook.yaml -K \
  -e @ocp/4.15/upi/ansible/defaults/main.yaml
----
