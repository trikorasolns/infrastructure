...
<1> RedHat Openshift cloud pull secret.
 ...
 On the Hybrid Cloud console _Services_ menu navigate to _Platform > RedHat OpenShift_. 
 On the _OpenShift Overview_ navigate to _Cluster List_ and press _Create Cluster_. 
...
Generate OCP Cluster installation and download the OCP binaries.
