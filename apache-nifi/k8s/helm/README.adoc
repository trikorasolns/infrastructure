...
[source,bash]
----
ansible-playbook apache-nifi/k8s/helm/ansible/apache-nifi-registry-install-playbook.yaml \
  -e @apache-nifi/k8s/ansible/defaults/nifi-registry.yaml \
...
[.lead]
Uninstall Apache Nifi Registry.

[source,bash]
----
ansible-playbook apache-nifi/k8s/helm/ansible/apache-nifi-registry-uninstall-playbook.yaml \
  -e @apache-nifi/k8s/ansible/defaults/nifi-registry.yaml
----
